  ...
  dynamixel_workbench_msgs__srv__GetDynamixelInfo_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    dynamixel_workbench_msgs__srv__GetDynamixelInfo_Request * data =
      (dynamixel_workbench_msgs__srv__GetDynamixelInfo_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!dynamixel_workbench_msgs__srv__GetDynamixelInfo_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          dynamixel_workbench_msgs__srv__GetDynamixelInfo_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  dynamixel_workbench_msgs__srv__GetDynamixelInfo_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    dynamixel_workbench_msgs__srv__GetDynamixelInfo_Response * data =
      (dynamixel_workbench_msgs__srv__GetDynamixelInfo_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!dynamixel_workbench_msgs__srv__GetDynamixelInfo_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          dynamixel_workbench_msgs__srv__GetDynamixelInfo_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
