...
void GetDynamixelInfo_Request__rosidl_typesupport_introspection_c__GetDynamixelInfo_Request_init_function(
...
void GetDynamixelInfo_Request__rosidl_typesupport_introspection_c__GetDynamixelInfo_Request_fini_function(void * message_memory)
{
  dynamixel_workbench_msgs__srv__GetDynamixelInfo_Request__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember GetDynamixelInfo_Request__rosidl_typesupport_introspection_c__GetDynamixelInfo_Request_message_member_array[1] = {
  {
...
static const rosidl_typesupport_introspection_c__MessageMembers GetDynamixelInfo_Request__rosidl_typesupport_introspection_c__GetDynamixelInfo_Request_message_members = {
  ...
  GetDynamixelInfo_Request__rosidl_typesupport_introspection_c__GetDynamixelInfo_Request_message_member_array,  // message members
  GetDynamixelInfo_Request__rosidl_typesupport_introspection_c__GetDynamixelInfo_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  GetDynamixelInfo_Request__rosidl_typesupport_introspection_c__GetDynamixelInfo_Request_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t GetDynamixelInfo_Request__rosidl_typesupport_introspection_c__GetDynamixelInfo_Request_message_type_support_handle = {
  0,
  &GetDynamixelInfo_Request__rosidl_typesupport_introspection_c__GetDynamixelInfo_Request_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dynamixel_workbench_msgs, srv, GetDynamixelInfo_Request)() {
  if (!GetDynamixelInfo_Request__rosidl_typesupport_introspection_c__GetDynamixelInfo_Request_message_type_support_handle.typesupport_identifier) {
    GetDynamixelInfo_Request__rosidl_typesupport_introspection_c__GetDynamixelInfo_Request_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &GetDynamixelInfo_Request__rosidl_typesupport_introspection_c__GetDynamixelInfo_Request_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
void GetDynamixelInfo_Response__rosidl_typesupport_introspection_c__GetDynamixelInfo_Response_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void GetDynamixelInfo_Response__rosidl_typesupport_introspection_c__GetDynamixelInfo_Response_fini_function(void * message_memory)
{
  dynamixel_workbench_msgs__srv__GetDynamixelInfo_Response__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember GetDynamixelInfo_Response__rosidl_typesupport_introspection_c__GetDynamixelInfo_Response_message_member_array[1] = {
  {
    "dynamixel_info",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers GetDynamixelInfo_Response__rosidl_typesupport_introspection_c__GetDynamixelInfo_Response_message_members = {
  "dynamixel_workbench_msgs__srv",  // message namespace
  "GetDynamixelInfo_Response",  // message name
  1,  // number of fields
  sizeof(dynamixel_workbench_msgs__srv__GetDynamixelInfo_Response),
  GetDynamixelInfo_Response__rosidl_typesupport_introspection_c__GetDynamixelInfo_Response_message_member_array,  // message members
  GetDynamixelInfo_Response__rosidl_typesupport_introspection_c__GetDynamixelInfo_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  GetDynamixelInfo_Response__rosidl_typesupport_introspection_c__GetDynamixelInfo_Response_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t GetDynamixelInfo_Response__rosidl_typesupport_introspection_c__GetDynamixelInfo_Response_message_type_support_handle = {
  0,
  &GetDynamixelInfo_Response__rosidl_typesupport_introspection_c__GetDynamixelInfo_Response_message_members,
  get_message_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dynamixel_workbench_msgs, srv, GetDynamixelInfo_Response)() {
  GetDynamixelInfo_Response__rosidl_typesupport_introspection_c__GetDynamixelInfo_Response_message_member_array[0].members_ =
  ...
  if (!GetDynamixelInfo_Response__rosidl_typesupport_introspection_c__GetDynamixelInfo_Response_message_type_support_handle.typesupport_identifier) {
    GetDynamixelInfo_Response__rosidl_typesupport_introspection_c__GetDynamixelInfo_Response_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &GetDynamixelInfo_Response__rosidl_typesupport_introspection_c__GetDynamixelInfo_Response_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
