...
struct DynamixelStateList_
{
  ...
  using _dynamixel_state_type =
    std::vector<dynamixel_workbench_msgs::msg::DynamixelState_<ContainerAllocator>, typename ContainerAllocator::template rebind<dynamixel_workbench_msgs::msg::DynamixelState_<ContainerAllocator>>::other>;
  _dynamixel_state_type dynamixel_state;

  // setters for named parameter idiom
  Type & set__dynamixel_state(
    const std::vector<dynamixel_workbench_msgs::msg::DynamixelState_<ContainerAllocator>, typename ContainerAllocator::template rebind<dynamixel_workbench_msgs::msg::DynamixelState_<ContainerAllocator>>::other> & _arg)
  {
