...
static size_t _DynamixelCommand_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_dynamixel_workbench_msgs__srv__DynamixelCommand_Request(
    full_bounded, 0);
}
...
static size_t _DynamixelCommand_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_dynamixel_workbench_msgs__srv__DynamixelCommand_Response(
    full_bounded, 0);
}
