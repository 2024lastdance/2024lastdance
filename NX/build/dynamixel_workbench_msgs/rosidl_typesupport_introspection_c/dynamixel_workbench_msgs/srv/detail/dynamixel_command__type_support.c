...
void DynamixelCommand_Request__rosidl_typesupport_introspection_c__DynamixelCommand_Request_init_function(
...
void DynamixelCommand_Request__rosidl_typesupport_introspection_c__DynamixelCommand_Request_fini_function(void * message_memory)
{
  dynamixel_workbench_msgs__srv__DynamixelCommand_Request__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember DynamixelCommand_Request__rosidl_typesupport_introspection_c__DynamixelCommand_Request_message_member_array[4] = {
  {
    "command",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers DynamixelCommand_Request__rosidl_typesupport_introspection_c__DynamixelCommand_Request_message_members = {
  ...
  DynamixelCommand_Request__rosidl_typesupport_introspection_c__DynamixelCommand_Request_message_member_array,  // message members
  DynamixelCommand_Request__rosidl_typesupport_introspection_c__DynamixelCommand_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  DynamixelCommand_Request__rosidl_typesupport_introspection_c__DynamixelCommand_Request_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t DynamixelCommand_Request__rosidl_typesupport_introspection_c__DynamixelCommand_Request_message_type_support_handle = {
  0,
  &DynamixelCommand_Request__rosidl_typesupport_introspection_c__DynamixelCommand_Request_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dynamixel_workbench_msgs, srv, DynamixelCommand_Request)() {
  if (!DynamixelCommand_Request__rosidl_typesupport_introspection_c__DynamixelCommand_Request_message_type_support_handle.typesupport_identifier) {
    DynamixelCommand_Request__rosidl_typesupport_introspection_c__DynamixelCommand_Request_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &DynamixelCommand_Request__rosidl_typesupport_introspection_c__DynamixelCommand_Request_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
void DynamixelCommand_Response__rosidl_typesupport_introspection_c__DynamixelCommand_Response_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void DynamixelCommand_Response__rosidl_typesupport_introspection_c__DynamixelCommand_Response_fini_function(void * message_memory)
{
  dynamixel_workbench_msgs__srv__DynamixelCommand_Response__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember DynamixelCommand_Response__rosidl_typesupport_introspection_c__DynamixelCommand_Response_message_member_array[1] = {
  {
    "comm_result",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers DynamixelCommand_Response__rosidl_typesupport_introspection_c__DynamixelCommand_Response_message_members = {
  "dynamixel_workbench_msgs__srv",  // message namespace
  "DynamixelCommand_Response",  // message name
  1,  // number of fields
  sizeof(dynamixel_workbench_msgs__srv__DynamixelCommand_Response),
  DynamixelCommand_Response__rosidl_typesupport_introspection_c__DynamixelCommand_Response_message_member_array,  // message members
  DynamixelCommand_Response__rosidl_typesupport_introspection_c__DynamixelCommand_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  DynamixelCommand_Response__rosidl_typesupport_introspection_c__DynamixelCommand_Response_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t DynamixelCommand_Response__rosidl_typesupport_introspection_c__DynamixelCommand_Response_message_type_support_handle = {
  0,
  &DynamixelCommand_Response__rosidl_typesupport_introspection_c__DynamixelCommand_Response_message_members,
  get_message_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dynamixel_workbench_msgs, srv, DynamixelCommand_Response)() {
  if (!DynamixelCommand_Response__rosidl_typesupport_introspection_c__DynamixelCommand_Response_message_type_support_handle.typesupport_identifier) {
    DynamixelCommand_Response__rosidl_typesupport_introspection_c__DynamixelCommand_Response_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &DynamixelCommand_Response__rosidl_typesupport_introspection_c__DynamixelCommand_Response_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
